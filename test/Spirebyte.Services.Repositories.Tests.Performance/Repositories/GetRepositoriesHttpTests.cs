...
public class GetRepositoriesHttpTests
{
    ...
    private Scenario BuildScenario()
    {
        ...
        {
            var url = $"{_performanceFixture.PerformanceOptions.BaseUrl}/repositories/?projectId={_performanceFixture.PerformanceOptions.ProjectId}";
            ...
            var request =  Http.CreateRequest("GET", url)
                ...
                .WithCheck(async response =>
                {
                    ...
                    return response.IsSuccessStatusCode && repositories.Length > 0
                        ? Response.Ok(repositories, (int)response.StatusCode) // we pass user object response to the next step
